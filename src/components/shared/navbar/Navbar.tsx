        ...
        >
          <div className="flex items-center justify-end max-xl:gap-x-5 sm:justify-between ">
            ...
            <div className="flex items-center gap-x-3 md:gap-x-6">
              <button className="custom-transition-button flex min-w-fit items-center gap-x-2 rounded-[10px] bg-C373F56 px-3 py-2 text-base font-bold text-CFFFFFF hover:bg-C09B65E hover:text-C282F41 md:py-[10px] lg:px-5">
